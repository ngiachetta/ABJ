...
```{r}
tjsp <- readr::read_rds("tjs/consulta_processual/TJSP/data-raw_SP/data_rds/d_cposg.rds")
```
...
```{r}
tjal <- readr::read_rds("tjs/consulta_processual/TJAL/data-raw_AL/cposg_rds_AL/cposg.rds")
```
...
```{r}
tjdft <- readr::read_rds("tjs/jurisprudencia/TJDFT/data-raw/rds_files/data.rds")
```
