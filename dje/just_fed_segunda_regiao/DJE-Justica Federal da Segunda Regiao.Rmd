...
obter_diarios <- function(orgao = "SJRJ", data_pub_inicial, data_pub_final, path_html, path_pdf){
  ...
  if(is.na(ultima_pagina)==F){
    ...
    for (i in 1:length(vetor_paginas)+1){
  ...
  files <- dir("data-raw/",full.names = TRUE, pattern = "page")
...
diarios <- obter_diarios(data_pub_inicial = "04-05-2015",data_pub_final = "22-05-2015", path_html = "data-raw/", path_pdf = "data-raw/data-raw_pdf/")
