...
# Download dos processos de acordo com a classes desejada (Coleta: 10:10)
...
files <- dir("/home/nathang/Documentos/Scripts and Documents/ESTAGIO_ABJ/ABJ/InqPolicial_AL-SP/data_raw_SP/cjsg_SP/", full.names = TRUE, pattern = "page")
...
esaj::download_cposg(processos, "/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data_raw_SP/cposg_SP/")

files_cposg <- dir("/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data_raw_SP/cposg_SP", full.names = TRUE)
...
d_cposg <- esaj::run_parser(file = files_cposg, parser = parser, 
                             path = "/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data_raw_SP/cposg_rds_SP/")

rds_files <- dir("/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data_raw_SP/cposg_rds_SP", full.names = TRUE)
d_cposg <- purrr::map_dfr(rds_files, readRDS)

# Download das decisoes
acordaos <- d_cjsg$id_decision %>% 
  na.omit()
esaj::download_decision(acordaos, path = "/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data_raw_SP/decision_SP")
```
...
```{r}
# Download 
path <- "/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data-raw_AL/cjsg_AL/"
...
esaj::download_cposg(processos, "/home/nathang/Documentos/Scripts and Documents/ABJ/InqPolicial_AL-SP/data_raw_SP/cposg_SP/")
esaj:::download_cposg_
esaj:::download_noc_lawsuit
```
